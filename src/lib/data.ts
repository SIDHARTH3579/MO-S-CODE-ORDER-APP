...
export const products: Product[] = [
  {
    ...
    category: "Lipstick",
    shades: ["Ruby Red", "Coral Kiss", "Nude Blush", "Deep Plum", "Rose Petal"],
    price: 24.99,
    ...getImage("prod_001"),
  },
  {
  ...
  },
  {
    ...
    shades: ["Candy Apple Red", "Ballet Slipper Pink", "Midnight Blue", "Silver Chrome"],
    price: 15.0,
    ...getImage("prod_009"),
  },
];
...
export let orders: Order[] = [
  ...
  },
  {
    ...
    userName: "Charlie (Agent)",
    items: [
        { productId: "prod_009", productName: "Gloss Bomb Nail Polish", quantity: 4, price: 15.00 },
        { productId: "prod_006", productName: "Precision Point Eyeliner", quantity: 2, price: 21.00 },
    ],
    total: 102.00,
    status: "Pending",
